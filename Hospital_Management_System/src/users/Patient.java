...
public class Patient extends User
{
    ...
    public static void patientMenu()
    {
        ...
        if(input == 1){
            ...
            //System.out.println("Enter Patient's : \n");
            String id = "0";
            System.out.println("Enter Patient's Age: \n");
            int age = sc.nextInt();
            HMSystem.patients.add(new Patient(name, surname, id, age));
            currPatient = HMSystem.patients.get(0);
        ...
        while(loop){
            ...
            else if(input == 2)
            {
                ...
                String patientID = currPatient.getId();
                ...
                System.out.println(currPatient.appointments);
            }
            else if(input == 4){
                System.out.println(currPatient.prescriptions);
                
            }
            else if(input == 5){
                System.out.println(currPatient.tests);
